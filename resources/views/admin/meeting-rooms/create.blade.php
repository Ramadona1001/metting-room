...
@section('title', 'إضافة غرفة اجتماعات')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">إضافة غرفة اجتماعات جديدة</h1>
        ...
        <form action="{{ route('admin.meeting-rooms.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="capacity" id="capacity" value="{{ old('capacity', 10) }}" min="1"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="max_booking_duration" id="max_booking_duration" value="{{ old('max_booking_duration', 120) }}" min="15" max="480"
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="time" name="working_hours_start" id="working_hours_start" value="{{ old('working_hours_start', '08:00') }}"
                           class="form-control">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="working_hours_end" class="form-label">نهاية ساعات العمل</label>
                    <input type="time" name="working_hours_end" id="working_hours_end" value="{{ old('working_hours_end', '18:00') }}"
                           class="form-control">
                </div>
            </div>
